...
public class AuthorForm extends javax.swing.JFrame {
     ...
     * @param authors
     */
    public AuthorForm(TableModelAuthor tma) {
        initComponents();
        this.tma=tma;
        prepareView();
    }
    ...
    private void initComponents() {
        ...
        cmbAuthors.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cmbAuthors.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbAuthorsItemStateChanged(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbAuthors, 0, 312, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void cmbAuthorsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbAuthorsItemStateChanged
       
    }//GEN-LAST:event_cmbAuthorsItemStateChanged

    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
       Author a=(Author) cmbAuthors.getSelectedItem();
       BookForm bf=new BookForm(new ViewBookForm());
       tma.addAuthor(a);
    ...
    private void fillComboBox() throws Exception {
        List<Author> list=Controller.getInstance().getAuthors();
